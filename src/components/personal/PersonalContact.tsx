  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h1 className="w-full text-center text-[22vw] md:text-[18vw] lg:text-[210px] xl:text-[260px] 2xl:text-[310px] leading-[0.8] font-bold text-white tracking-tighter whitespace-nowrap">
