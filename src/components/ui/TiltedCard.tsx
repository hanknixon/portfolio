...
export default function TiltedCard({
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 rounded-[8px] bg-green-400 px-[12px] py-[6px] text-[12px] text-black font-medium opacity-0 z-[3] hidden sm:block shadow-lg"
          style={{
            x,
            y,
            opacity,
