...
const Loader = () => {
  const loaderCss = `
    .loader {
      --duration: 3s;
      /* Updated to use green theme colors */
      --primary: rgba(16, 185, 129, 1); /* green-400 */
      --primary-light: rgba(34, 197, 94, 1); /* green-500 */
      --primary-rgba: rgba(16, 185, 129, 0);
      width: 200px;
      height: 320px;
      position: relative;
    ...
    .loader:before, .loader:after {
      ...
      right: 32%;
      bottom: -11px;
      /* Updated to match your dark background */
      background: #1d1d22; 
